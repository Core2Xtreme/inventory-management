...
export default {
  ...
  setup() {
    ...
    // Summary stats as computed properties derived from raw data refs
    ...
    // Precomputed max revenue for O(1) bar height lookups
    ...
    const formatNumber = (num) => {
      return Number(num).toLocaleString(currentLocale.value === 'ja' ? 'ja-JP' : 'en-US', {
